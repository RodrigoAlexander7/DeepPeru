...
import type { CreateActivityDto } from '@/types/Activity';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-red-500 to-pink-500 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold">Crear Nueva Actividad</h1>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej: Tour Guiado por el Centro Histórico"
                  />
                </div>
